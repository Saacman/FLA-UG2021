...
# Get Sphere handle, to know its position
err, sphere = vrep.simxGetObjectHandle(
...
# Initialize the map
err, pos0 = vrep.simxGetObjectPosition(clientID, sphere, -1, vrep.simx_opmode_blocking)
pos0 = np.array(pos0)
